...
QT_MOC_LITERAL(1, 15, 14), // "saveFirstPhoto"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 21), // "receiveFirstPhotoPath"
QT_MOC_LITERAL(4, 53, 8) // "saveDate"

    },
    "PlayBackThread\0saveFirstPhoto\0\0"
    "receiveFirstPhotoPath\0saveDate"
};
...
void PlayBackThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->saveFirstPhoto(); break;
        case 1: _t->receiveFirstPhotoPath((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->saveDate(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayBackThread::saveFirstPhoto)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PlayBackThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_PlayBackThread.data,
      qt_meta_data_PlayBackThread,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void PlayBackThread::saveFirstPhoto()
{
