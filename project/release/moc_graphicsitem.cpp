...
QT_MOC_LITERAL(1, 13, 15), // "enterSettingWin"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "advance"
QT_MOC_LITERAL(4, 38, 5) // "phase"

    },
    "GraphicsItem\0enterSettingWin\0\0advance\0"
    "phase"
};
...
void GraphicsItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->enterSettingWin(); break;
        ...
        {
            typedef void (GraphicsItem::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsItem::enterSettingWin)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GraphicsItem::enterSettingWin()
{
